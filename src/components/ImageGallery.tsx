...
const ImageGallery: React.FC = () => {
  ...
  const images = publishedGallery.length > 0 
    ...
    : [
        { url: 'https://res.cloudinary.com/dedcmctqk/image/upload/v1749911301/raphael-ai_19_jowg5v.jpeg', title: 'BDRRM Training Workshop', description: 'Barangay officials training' },
